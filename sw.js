...
// Version: 3.11.0 - Fixed button clicks, mobile view, notifications
// ========================================

const CACHE_NAME = 'curriculum-tracker-v3.11.0';
const APP_SHELL_CACHE = 'app-shell-v3.11.0';
...
self.addEventListener('install', (event) => {
  console.log('[SW] Installing Service Worker v3.11.0');
...
self.addEventListener('activate', (event) => {
  console.log('[SW] Activating Service Worker v3.11.0');
...
console.log('[SW] Service Worker v3.11.0 loaded');
